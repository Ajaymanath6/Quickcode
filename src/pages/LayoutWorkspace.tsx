  ...
  return (
    <div className="flex h-full min-h-0 flex-1 flex-col bg-[var(--canvas-fill)]">
      <div className="flex min-h-0 flex-1 items-center justify-center p-8">
        <div className="max-w-md rounded-xl border border-dashed border-brandcolor-strokeweak bg-white px-6 py-10 text-center">
          <h2 className="text-sm font-semibold text-brandcolor-textstrong">Layout workspace</h2>
          <p className="mt-2 text-[13px] text-brandcolor-textweak">
          ...
          <p className="mt-4 text-[13px] text-brandcolor-textstrong">
            {entries.length === 0
              ? 'No prompts yet.'
